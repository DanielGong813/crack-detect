...
# ===================== 配置参数 =====================
MODEL_PATH = "C:/Users/11/Desktop/car_detect_final/yolov8n-seg-cracks-joints.pt"
CAR_IP = "192.168.1.1"
CAR_PORT = 2001
...
AUTO_CAPTURE_PATH = "C:/Users/11/Desktop/car_captures/auto"
MANUAL_CAPTURE_PATH = "C:/Users/11/Desktop/car_captures/manual"
...
class VideoWorker(QThread):
    ...
    def __init__(self):
        ...
        # 模型类别定义（根据你提供的信息固定）
        self.CLASS_JOINT = 0    # 接缝
        self.CLASS_CRACK = 1    # 裂缝
        try:
            self.model = YOLO(MODEL_PATH)
            self.log_signal.emit("✅ YOLO模型加载成功")
            self.log_signal.emit(f"📌 模型类别：0=接缝(Joint)，1=裂缝(Crack)")
            self.log_signal.emit("🔧 当前配置：仅检测并显示裂缝(Crack)类别")
        except Exception as e:
